...
엣지 32개. 그 차이는 지금 362개 대 275개로 좁아졌는데, 파이프라인은 그 이유를 말해 주지
못합니다. 매일 분석을 통과하는 기사가 늘었고, 2026-09-13 에 점수 매기는 방식도 바뀌었기
때문입니다. "국회가 원래 갈등투성이다" 와 "갈등이 주로 기사가 된다" 도 가려내지 못합니다.
볼 수 있는 것이 보도뿐이기 때문입니다. 그래서 이 치우침을 세탁하지 않고 드러내는 쪽으로 설계돼
